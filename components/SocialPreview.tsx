    ...
    >
      <Link href={item.href} target="_blank" rel="noopener noreferrer">
        <motion.div
          ...
          style={{
            background: `linear-gradient(145deg, ${item.accentColor}08 0%, transparent 50%)`,
          }}
        >
          <div
            className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
            style={{
              background: `radial-gradient(ellipse at 30% 80%, ${item.accentColor}15, transparent 60%)`,
            }}
          />
          ...
          <div className="relative z-10 p-6 sm:p-7">
            <div className="flex items-start justify-between mb-8">
              ...
              >
                <PlatformIcon icon={item.icon} className="w-5 h-5" />
              </div>

              <svg
                className="w-4 h-4 text-muted opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5"
                viewBox="0 0 16 16"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
            ...
            <div className="mt-5 flex items-center gap-2">
              ...
              <div
                ...
                style={{ background: item.accentColor, opacity: 0.5 }}
              />
            </div>
          </div>
        </motion.div>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-end justify-between mb-12">
          ...
          >
            <Link
              href="/social"
              className="text-sm font-mono text-muted hover:text-accent transition-colors duration-300 flex items-center gap-1.5"
            >
              View All
              <svg
